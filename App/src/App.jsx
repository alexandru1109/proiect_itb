...
import { SuiClientProvider, useWallets, WalletProvider } from '@mysten/dapp-kit';
...
const BridgeContent = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-t from-fuchsia-500 to-zinc-950" style={{ gap: "10px" }}>
      <Card className="w-full max-w-4xl shadow-xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center bg-gradient-to-r from-fuchsia-500 to-fuchsia-500 bg-clip-text text-transparent">
            Wallets
          </CardTitle>
          <p className="text-center text-gray-500 text-sm">Crypto wallets and balances</p>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-4">
            {!ethConnected && (
              <Button 
                className="w-full bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:opacity-90 transition-all" 
      ...
      <Card className="w-full max-w-4xl shadow-xl">
        ...
        <CardContent className="space-y-8">
          ...
          <div className="w-full max-w-2xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
              <div className="flex-1">
                <Select value={sourceChain} onValueChange={setSourceChain}>
                  <SelectTrigger className="w-full">
                    <SelectValue color="white" placeholder="Source Chain" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex-1">
                <Select value={destinationChain} onValueChange={setDestinationChain}>
                  <SelectTrigger className="w-full">
                    <SelectValue className="text-fuchsia-500" placeholder="Destination Chain" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="ethereum">Ethereum</SelectItem>
                    <SelectItem value="sui">Sui</SelectItem>
            ...
            <Button
              className="w-full bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:opacity-90 transition-all text-white"
